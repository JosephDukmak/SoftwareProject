...
<section class="wrapper" style="margin-left: 16%;margin-top: -5%;">
	...
	<ul class="nav nav-tabs" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link active" data-toggle="tab" href="#home" role="tab">House/Apartment Registration</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Room Registration</a>
	  </li>
	</ul>
